...
file_path = r'E:\AIWeb-main\AIWeb-main\backend\uploads\2911c6340a544bacb0e51092d9828f2e.csv'
output_file = r'E:\AIWeb-main\AIWeb-main\backend\outputs\分箱结果_headtail5_4bdc1134.xlsx'
label = 'target'
time_col = 'loan_date'
...
drop_cols = ['client_id', 'apply_id', 'money', 'fact_money', 'fact_repay_money', 'risk_over_days', 'pk_id', 'source_type', 'loan_term_bill_pid', 'Unnamed: 0', 'back_time', 'create_time', 'target']
...
# ==================== SPLIT TRAIN/TEST (iloc per zhunru SOP) ====================
