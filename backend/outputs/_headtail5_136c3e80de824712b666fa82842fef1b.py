...
file_path = r'E:\AIWeb-main\AIWeb-main\backend\uploads\a182a7a3cafc4d1592f2847803188081.csv'
output_file = r'E:\AIWeb-main\AIWeb-main\backend\outputs\分箱结果_headtail5_781d7b7a.xlsx'
label = 'target'
time_col = 'loan_date'
...
drop_cols = ['client_id', 'apply_id', 'money', 'fact_money', 'fact_repay_money', 'risk_over_days', 'Unnamed: 0.1', 'Unnamed: 0', 'pk_id', 'source_type', 'loan_term_bill_pid', 'target']
