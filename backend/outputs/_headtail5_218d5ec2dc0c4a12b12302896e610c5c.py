...
file_path = r'E:\AIWeb-main\AIWeb-main\backend\uploads\b0200ba07acf4d2ea98c67a3c1afa495.csv'
output_file = r'E:\AIWeb-main\AIWeb-main\backend\outputs\x.xlsx'
label = 'overdue_flag'
time_col = 'apply_time'
...
drop_cols = ['client_id', 'apply_id', 'pid', 'money', 'fact_money', 'risk_over_days', 'overdue_flag']
...
def _ht5_fit_one_var(task):
    (var, sample_type_sub, target_sub, min_rate, sub_div_bin, min_num,
     is_cate, x_vals, y_vals, var_msg_records) = task
...
def _ht5_apply_one_var(task):
    (var, sample_type_sub, target_sub, is_cate, x_vals, y_vals,
     train_info, var_msg_records) = task
        ...
        for target_sub in target:
            ...
            for var in mydata1.columns[:-1]:
                ...
                fit_tasks.append((
                    ...
                    var in cate_cols,
                    mydata1[var].values,
                    mydata1[target_sub].values,
                    var_msg.to_dict('records'),
                ))
            ...
            for target_sub in target:
                ...
                for var in mydata1_test.columns[:-1]:
                    ...
                    apply_tasks.append((
                        ...
                        mydata1_test[var].values,
                        mydata1_test[target_sub].values,
                        train_stored_edges[var],
                        var_msg.to_dict('records'),
                    ))
